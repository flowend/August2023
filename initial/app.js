...
async function loadFacts() {
  const res = await fetch(
    "https://zikxrlkxenvuwrxxbfra.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authoziation:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inppa3hybGt4ZW52dXdyeHhiZnJhIiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODg0MTA3NTksImV4cCI6MjAwMzk4Njc1OX0.AipYH_LO6Zu_WqoepmARqtG1EZ-vY2Nb6BGsGMLIhhs",
      },
    }
  );
...
//   if (age >= 0) return age;
//   else return `Year needs to be less or equal ${currentYear}`;
// }
